...
public final class CameraPanelNew extends JPanel implements ImageListener, TagListener {
    ...
    public CameraPanelNew(final IARDrone drone) {
        this.drone = drone;
