...
public final class CircleCalculations {
    ...
    public final CircleAnalyse c1;
    public final CircleAnalyse c2;
    ...
    public final Vectorize radicalPoint;
    public final double distanceC1cRadicalLine;
    public final double distanceC2cRadicalLine;
    public final Vectorize versorC1cC2c;
    public final Vectorize versorRadicalLine;

    // Results valid for tangent circles:
    public final Vectorize intersectionPoint;

    // Results valid for overlapping circles:
    public final Vectorize intersectionPoint1;
    public final Vectorize intersectionPoint2;
    public final double distanceRadicalPointIntersectionPoints;

    public CircleCalculations(CircleAnalyse c1, CircleAnalyse c2) {
        this.c1 = c1;
        this.c2 = c2;

        // Vector going from c1 center to c2 center:
        Vectorize vectorC1cC2c = c2.v.sub(c1.v);
        ...
        radicalPoint = c1.v.add(versorC1cC2c.scale(distanceC1cRadicalLine));
    ...
    public Vectorize[] getIntersectionPoints() {
        switch (type.getIntersectionPointCount()) {
            case 0:
                return new Vectorize[] {};
            case 1:
                return new Vectorize[] { intersectionPoint };
            case 2:
                return new Vectorize[] { intersectionPoint1, intersectionPoint2 };
            default:
